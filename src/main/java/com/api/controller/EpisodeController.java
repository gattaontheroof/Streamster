...
//	@GetMapping("{show_id}/episodes")
//	public ResponseEntity<Object> getEpisodeInShow(@PathVariable int showId){
//		return ResponseEntity
//				.status(HttpStatus.OK)
//				.body(episodeService.findEpisodesByShowId(showId));	
//	}
	
	@GetMapping("{show_id}/{episode-id}")
	public ResponseEntity<Object> getEpisodeById(@PathVariable int episodeId){
		return ResponseEntity
				.status(HttpStatus.OK)
				.body(episodeService.findById(episodeId));	
	}
